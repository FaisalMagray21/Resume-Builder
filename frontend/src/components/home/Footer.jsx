...
export default function Footer() {
    ...
    {/* GitHub */}
    <a
        href="https://github.com/FaisalMagray21"
        target="_blank"
    ...
    >
        ...
        >
            <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-8 0C5.27.65 4.09 1 4.09 1A5.07 5.07 0 0 0 4 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 8 18.13V22"></path>
        </svg>
    </a>

    {/* LinkedIn */}
    <a
        href="https://www.linkedin.com/in/faisalmehmood807/"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="LinkedIn"
    >
    ...
    {/* GitHub (Second Icon can be changed if you want another platform) */}
    <a
        href="https://github.com/FaisalMagray21"
        target="_blank"
        rel="noopener noreferrer"
    ...
    >
        ...
        >
            <path d="M22 12a10 10 0 1 1-18.2 5.3L2 22l4.8-1.8A10 10 0 1 1 22 12z"></path>
            <path d="M8 9c0 4 4 7 8 7"></path>
            <path d="M15.5 13.5c-.3.8-1.1 1.3-1.9 1.2-2.2-.5-4.1-2.4-4.6-4.6-.1-.8.4-1.6 1.2-1.9"></path>
        </svg>
    </a>
</div>
