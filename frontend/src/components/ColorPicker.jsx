...
const ColorPicker = ({ selectedColor, onChange }) => {
  const colors = [
    ...
    { name: 'Purple', value: '#8B5CF6' }, // added missing #
    { name: 'Green', value: '#10B981' },
    { name: 'Red', value: '#EF4444' },
    { name: 'Orange', value: '#F97316' },
    { name: 'Teal', value: '#14B8A6' },
    { name: 'Pink', value: '#EC4899' },
    { name: 'Gray', value: '#6B7280' }, // added missing #
  ...
  return (
    <div className="relative">
      <button
        ...
        from-purple-50 to-purple-100 ring-purple-300 hover:ring transition-all px-3 py-2
        rounded-lg"
      >
        <Palette size={16} />
