...
const ProfessionalSummaryForm = ({ data, onChange, setResumeData }) => {
 ...
 try {
  ...
  return (
    <div className="space-y-4 w-full max-w-3xl mx-auto"> {/* ✅ Limits width */}
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-sm text-gray-500'>
            Add Summary from your resume here
          </p>
        </div>
...
{isGenerating ?"Enhancing...":"AI Enhance"}
      ...
      <div className='mt-6'>
        ...
        <p className='text-xs text-gray-500 max-w-[80%] mx-auto text-center'>
          Tip: Keep it concise (3–4 sentences) and focused on your most relevant skills and experiences.
        </p>
      </div>
    </div>
  )
