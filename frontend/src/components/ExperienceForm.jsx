...
const ExperienceForm = ({ data, onChange }) => {
  ...
  const [isEnhancing, setIsEnhancing] = useState(null) // track which index is enhancing
  ...
  const enhanceDescription = async (index) => {
    try {
      ...
      const prompt = `Enhance my job description: ${experience.description} for the position of
            ...
            <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
              ...
              <div className='space-y-2'>
                <div className='flex items-center justify-between'>
                  ...
                  <button
                    onClick={() => enhanceDescription(index, experience.description)}
